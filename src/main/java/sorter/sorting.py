...
def sorting(genre):
	...
	movite_titles['sorter'] = movie_titles['rating'] * movie_titles['numRatings']

	new = movie_titles[movie_titles['numRatings'] > 10].sort_values(by='sorter', ascending=False).head(20)
	print(new.head())
